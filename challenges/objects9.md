...
* title: get_odd_length_words_at_property

### !question

Write a function called "get_odd_length_words_at_property".

Given a dictionary and a key, "get_odd_length_words_at_property" returns a list containing all the odd length word elements of the list located at the given key.
...
output = get_odd_length_words_at_property(obj, 'key')
...
class TestScript(unittest.TestCase):
    def test_00(self):
        ...
        obj = {'key': ['It', 'has', 'some', 'words']}
        self.assertIsInstance(main.get_odd_length_words_at_property(obj, 'key'), list,
        msg = 'should return a list')

    def test_0(self):
        # it should return a list containing all the odd length elements of the list located at key
        obj = {'key': ['a', 'night', 'to', 'remember']}
        self.assertEqual(main.get_odd_length_words_at_property(obj, 'key'), ["a", "night"],
    ...
    def test_1(self):
        ...
        self.assertEqual(main.get_odd_length_words_at_property(obj, 'key'), [],
...
* title: get_average_of_elements_at_property

### !question

Write a function called "get_average_of_elements_at_property".

Given a dictionary and a key, "get_average_of_elements_at_property" returns the average of all the elements in the list located at the given key.
...
output = get_average_of_elements_at_property(obj, 'key')
print(output) # --> 2
```
...
class TestScript(unittest.TestCase):
    def test_00(self):
        ...
        obj = {'key': [1, 2, 3]}
        self.assertIsInstance(main.get_average_of_elements_at_property(obj, 'key'),
        (int,float),
    ...
    def test_0(self):
        ...
        obj = {'key': [0, 0, 30]}
        self.assertEqual(main.get_average_of_elements_at_property(obj, 'key'), 10,
    ...
    def test_1(self):
        ...
        obj = {'key': []}
        self.assertEqual(main.get_average_of_elements_at_property(obj, 'key'), 0,
...
* title: get_even_length_words_at_property

### !question

Write a function called "get_even_length_words_at_property".

Given a dictionary and a key, "get_even_length_words_at_property" returns a list containing all the even length word elements of the list located at the given key.
...
output = get_even_length_words_at_property(obj, 'key')
...
class TestScript(unittest.TestCase):
    def test_00(self):
        # it should return a list
        obj = {'key': ['It', 'has', 'some', 'words']}
        self.assertIsInstance(main.get_even_length_words_at_property(obj, 'key'), list,
        msg = 'should return a list')

    def test_0(self):
        # it should return a list containing all the even length elements of the list located at key
        obj = {'key': ['It', 'has', 'some', 'long','words']}
        self.assertEqual(main.get_even_length_words_at_property(obj, 'key'), ['some', 'long'],
    ...
    def test_1(self):
        ...
        self.assertEqual(main.get_even_length_words_at_property(obj, 'key'), [],
    ...
    def test_2(self):
        # it should return an empty list if the list is empty
        obj = {'key1': []}
        self.assertEqual(main.get_even_length_words_at_property(obj, 'key1'), [],
        msg = 'should return an empty list if the list is empty')
