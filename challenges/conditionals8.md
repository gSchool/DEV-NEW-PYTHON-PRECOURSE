...
Write a function called "convert_score_to_gradeWithPlusAndMinus".

Given a score, "convert_score_to_gradeWithPlusAndMinus" returns a string representing the letter grade corresponding to the given score.
...
```
output = convert_score_to_gradeWithPlusAndMinus(91)
print(output) # --> 'A-'
```
...
```python
def convert_score_to_gradeWithPlusAndMinus(score):
    # your code here
    pass
